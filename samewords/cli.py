...
def parse_config_file(filename: str) -> None:
    ...
    try:
        ...
        settings["multiword"] = user_conf.get("multiword", settings["multiword"])
        # TODO: Add test for this multiword config setting.
    except FileNotFoundError as e:
        raise FileNotFoundError(
            "The config file '{}' does not exist.".format(filename)
        ) from e
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        action="store",
        help=(
            "Location of the output. You can specify a filename as part of "
    ...
    parser.add_argument(
        ...
        action="store",
        help=(
            "Location of the configuration file. For information on what it "
