...
long_proximate_before_after_result = r"""List comprehensions provide \sameword{a} concise \sameword{a} way \sameword{to} create lists. \sameword{Common} applications are \sameword{to} make new lists where each element is the result \sameword{of} some operations applied \sameword{to} each member \sameword{of} another sequence or iterable, or \edtext{\sameword[1]{to}}{\lemma{\sameword{to}}\Bfootnote{note}} create \sameword{a} subsequence \sameword{of} those elements that satisfy \sameword{a} certain condition. List comprehensions provide \sameword{a} concise way \sameword{to} create lists. \edtext{\sameword[1]{Common}}{\lemma{\sameword{Common}}\Bfootnote{note}} applications are to make new lists where each element is the result \sameword{of} some operations applied to each member \sameword{of} another sequence or iterable, or to create \sameword{a} subsequence \sameword{of} those elements that satisfy \sameword{a} certain condition. Start \edtext{\sameword[1]{a}}{\lemma{\sameword{a}}\Bfootnote{lvl 1}} and another \sameword{a} List comprehensions provide \sameword{a} concise way to create lists. Common applications are to make new lists where each element is the result \sameword{of} some operations applied to each member \sameword{of} another sequence or iterable, or to create \sameword{a} subsequence \edtext{\sameword[1]{of}}{\lemma{\sameword{of}}\Bfootnote{note}} those elements that satisfy a certain condition."""
...
class TestProximityListing:
    ...
    def test_proximity_listing_left(self):
        ...
        assert Context().iter_proximate_words(input_list, index=len(input_list) - 1,
                                               side='left') == output_list
    ...
    def test_proximity_listing_right(self):
        ...
        assert Context().iter_proximate_words(self.simple_string, side='right') == output_list
