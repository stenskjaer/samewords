...
See some quick results by `trying out the online web service <http://samewords.stenskjaer.net/>`__.
...
I provide no guarantees for the integrity of your software or editions when you
use the package.

Copyright © 2019 Michael Stenskjær Christensen, MIT License.
