...
nested_ldots_lemma_result = r"""\sameword{sw} and \edtext{\sameword[1]{sw} so \edtext{\edtext{\sameword[3]{sw}}{\lemma{\sameword{sw}}\Bfootnote{lvl 3 note}} another thing \edtext{and \sameword[1]{more}}{\lemma{and \sameword[1]{more}}\Bfootnote{lvl 3 note}}}{\lemma{sw another thing and \sameword[1]{more}}\Bfootnote{lvl 2 note}}}{\lemma{\sameword{sw} \ldots \sameword{more}}\Afootnote{lvl 1 note}} and a \sameword{sw} after and one \sameword{more} \edtext{flat}{\lemma{flat}\Bfootnote{note here}} entry."""
